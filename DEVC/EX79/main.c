/* Project 79  -- LINKED LIST
   ...
   ************************************************************
   Representation of the Memories Blocks: (https://asciiflow.com/)
       ...
       Address     Memory
	           +-------------+
	*first     ж  ж ж ж  ж ж +--? NULL  -> 80186
	           +--+-+-+--+-+-ж                   ж
	*current   ж  ж ж ж  ж ж +--? NULL  -> 80186-ж> NULL -> 90144  -> NULL
	           +--+-+-+--+-+-ж                   ж
	*previous  ж  ж ж ж  ж ж +--? NULL  -> 80186 +--------> 90144 
	           +-------------ж                   ж                ж
	           ж     ...     ж                   ж                ж
	           ж             ж                   ж                ж
	    80186  +-------------ж   Register1 <-----+                ж
	...
	UNINTER - Curso: Engenharia da Computaчуo
	Escola Superior Politщcnica
