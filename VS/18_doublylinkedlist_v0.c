/* Project 18  -- DOUBLY LINKED LIST

    18_DOUBLYLINKEDLIST_V0.C
    ------------------------
	...
	************************************************************
	...
	Please enter the Artist Name: Frank Sinatra

	Please enter the Music Name: Ive Got You Under My Skin

	Please enter the Track Duration (sec): 457

	Do you What to enter a Track now (Y or N)?Y

	Please enter the Track Number: 2

	Please enter the Artist Name: Caetano Veloso

	Please enter the Music Name: Anjos Tronxos 

	Please enter the Track Duration (sec): 478

	Do you What to enter a Track now (Y or N)?N

	You have Entered these Musics:

	__________________________Tracks______List____________________________
	| Track |  Artist Name  |         Music Title         | Time(sec) |
	----------------------------------------------------------------------
	| 2 | Caetano Veloso | Anjos Tronxos | 478 |
	| 1 | Frank Sinatra | Ive Got You Under My Skin | 457 |
